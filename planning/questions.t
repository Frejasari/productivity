...
# how to add / edit a package? 
  - save button?
  - save on focus change?
  - save every X seconds? ---> Then check for changes, and only save if there are changes (how?)
...
# Make Project Ideas public to connect to other people and find skills you need? -
  - Add a Skill-set to your Profile
  - View other peoples public projects? Read/Write/Private access to set on Projects
  - Request access
  - Search for people with needed skills
